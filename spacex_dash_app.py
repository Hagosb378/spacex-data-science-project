...
# Author: Adapted for Coursera Skills Network Labs
# -----------------------------------------------
...
# TASK 4: Add a callback function for two inputs, `site-dropdown` and `payload-slider`, and output as `success-payload-scatter-chart`
